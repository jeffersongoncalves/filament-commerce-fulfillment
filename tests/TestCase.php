...
namespace JeffersonGoncalves\FilamentCommerce\Fulfillment\Tests;
...
use JeffersonGoncalves\FilamentCommerce\Fulfillment\FilamentCommerceFulfillmentServiceProvider;
use JeffersonGoncalves\FilamentCommerce\Fulfillment\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentCommerce\Fulfillment\Tests\Fixtures\TestUser;
...
abstract class TestCase extends CommerceFilamentTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentCommerceFulfillmentServiceProvider::class,
